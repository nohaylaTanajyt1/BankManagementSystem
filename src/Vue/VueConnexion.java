...
public class VueConnexion extends JFrame {
	...
	public VueConnexion() {
		...
		btnConnexion.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent actionEvent) {
				new CtlConnexion(VueConnexion.this, new MdlConnexion(textField.getText(),new String (passwordField.getPassword()),comboBox.getSelectedItem().toString())).authentification();
			}
		});
