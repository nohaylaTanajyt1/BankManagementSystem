...
public class VueModifierEmploye extends JPanel {
	 ...
	 * Create the panel.
	 */
	public VueModifierEmploye(VueEmploye p, Employe c) {
		parent = p;
		client = c;
		...
		JLabel lblNomClient = new JLabel("Nom Employe :         ");
		...
		JLabel lblPrenomClient = new JLabel("Prenom Employe :     ");
